...
export default function Home() {
  return (
      <div className='w-[100%] h-full center flex-col bg-[url(../public/background.png)] bg-center bg-cover p-[20px]'>
        ...
        <input type="text" className='input my-[20px]' placeholder='First Name'/>
        <input type="text" className='input my-[20px]' placeholder='Second Name'/>
        <input type="text" className='input my-[20px]' placeholder='E-mail'/>
        <input type="password" className='input my-[20px]' placeholder='Password'/>
